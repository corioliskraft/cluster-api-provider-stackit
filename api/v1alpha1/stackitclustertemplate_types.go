...
type StackitClusterTemplateSpec struct {
	...
	// foo is an example field of StackitClusterTemplate. Edit stackitclustertemplate_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// StackitClusterTemplateStatus defines the observed state of StackitClusterTemplate.
type StackitClusterTemplateStatus struct {
	...
	// conditions represent the current state of the StackitClusterTemplate resource.
...
type StackitClusterTemplate struct {
	...
	// status defines the observed state of StackitClusterTemplate
	// +optional
	Status StackitClusterTemplateStatus `json:"status,omitzero"`
}
