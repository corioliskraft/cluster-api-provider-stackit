...
| PR 7 | Kubernetes upgrade e2e | worker replacement done |
| PR 8 | failure domains / availability zones | done |
| PR 9 | ClusterClass support | templates done |
| PR 10 | ClusterTopology validation flow | local config and validation done |
